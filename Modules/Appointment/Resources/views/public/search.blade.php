...
<div class="search-shell">
    ...
    <div class="search-container">
        ...
        <form id="searchForm" class="search-form" method="POST" action="{{ route('public.appointment.request') }}" enctype="multipart/form-data">
            @csrf
            ...
            <fieldset class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-lg-3">
                        ...
                        <input type="text" name="nin" class="form-control" placeholder="AB123456" required value="{{ old('nin') }}">
                    </div>
                    <div class="col-lg-3">
                        <label class="form-label">Prénom <span class="text-danger">*</span></label>
                        <input type="text" name="first_name" class="form-control" placeholder="Jean" required value="{{ old('first_name') }}">
                    </div>
                    <div class="col-lg-3">
                        <label class="form-label">Nom <span class="text-danger">*</span></label>
                        <input type="text" name="last_name" class="form-control" placeholder="Dupont" required value="{{ old('last_name') }}">
                    </div>
                    <div class="col-lg-3">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="tel" name="phone" class="form-control" placeholder="06 XX XX XX XX" value="{{ old('phone') }}">
                    </div>
                    <div class="col-lg-3">
                        <label class="form-label">Email</label>
                        <input type="email" name="email" class="form-control" placeholder="jean@email.fr" value="{{ old('email') }}">
                    </div>
                    <div class="col-lg-6">
            ...
            <fieldset class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-lg-4">
                        ...
                        <select name="service_id" id="serviceSelect" class="form-select" value="{{ old('service_id') }}">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select name="appointment_type_id" id="acteSelect" class="form-select" value="{{ old('appointment_type_id') }}">
                    ...
                    <div class="col-lg-4">
                        ...
                        <select name="professional_id" id="proSelect" class="form-select" value="{{ old('professional_id') }}">
                            <option value="">Tous les spécialistes</option>
                            @foreach($professionals as $pro)
                                <option value="{{ $pro->id }}">{{ $pro->display_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <fieldset class="form-section">
                ...
                <div class="row g-3">
                    <div class="col-lg-4">
                        ...
                        <input type="date" name="preferred_date_from" class="form-control" value="{{ old('preferred_date_from', now()->addDay()->format('Y-m-d')) }}">
                    </div>
                    <div class="col-lg-4">
                        <label class="form-label">Jusqu'au</label>
                        <input type="date" name="preferred_date_to" class="form-control" value="{{ old('preferred_date_to', now()->addDays(14)->format('Y-m-d')) }}">
                    </div>
                    <div class="col-lg-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="notes" class="form-control" rows="3" placeholder="Décrivez brièvement le motif...">{{ old('notes') }}</textarea>
                    </div>
                </div>
            </fieldset>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function triggerSearch() {
        ...
        fetch('{{ route("public.appointment.slots.json") }}?' + params.toString())
            .then(r => r.json())
            .then(data => {
