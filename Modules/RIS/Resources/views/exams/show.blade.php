                            ...
                            <div class="risx-editor-shell risx-card">
                                <div class="risx-editor-toolbar">
                                    ...
                                    <div style="margin-left:auto; display:flex; gap:8px;">
                                        <button type="button" id="wordTemplateImportButton" class="risx-btn" @disabled($isLocked)>Charger modele Word</button>
                                        ...
                                        <button type="button" id="voiceDictationButton" class="risx-btn" @disabled($isLocked)>Dictee</button>
                                        <button type="button" id="aiAssistButton" data-ai-url="{{ route('ris.exams.ai.analyze', $order) }}" class="risx-btn risx-btn-ai" @disabled($isLocked)>✦ Analyser IA</button>
                                    </div>
                                </div>
