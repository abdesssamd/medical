...
@php
    ...
    // Définition des éléments de menu (identique)
    $menu = [];
    if ($isAdmin) {
        $menu = [
            ...
            ['label' => 'Administration des paramètres', 'icon' => 'ti ti-settings-automation', 'route' => 'clinical.questionnaire-templates.index', 'active' => 'clinical.questionnaire-templates.*'],
        ];
...
<aside class="sidebar-modern" id="sidebar">
    ...
    <ul class="nav-menu">
        @foreach($menu as $item)
            ...
            <li class="nav-item">
                <a class="nav-link-modern {{ $isActive ? 'active' : '' }}" href="{{ route($item['route'], $item['params'] ?? []) }}">
                    <i class="{{ $item['icon'] }}"></i>
...
<!-- Scripts pour le toggle mobile et conserver les fonctionnalités -->
<script>
...
<!-- Injection des scripts Bootstrap et autres dépendances nécessaires -->
<script>
