        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="pregnancyForm">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="id" id="pregnancyRecordId" value="<?php echo e($pregnancy?->id); ?>">
                    ...
                    <div class="preg-form-section">
                        ...
                        <div class="preg-form-grid preg-form-grid-3">
                            <div class="preg-field">
                                ...
                                <input type="text" name="pregnancy_number" id="pregnancyNumber" class="form-control" placeholder="G1, G2..." value="<?php echo e(old('pregnancy_number', $pregnancy?->pregnancy_number)); ?>">
                            </div>
                            <div class="preg-field">
                                <label>DDR (Date dernières règles) *</label>
                                <input type="date" name="lmp_date" id="lmpDate" class="form-control" required value="<?php echo e(old('lmp_date', $pregnancy?->lmp_date?->format('Y-m-d'))); ?>">
                            ...
                            <div class="preg-field">
                                ...
                                <select name="pregnancy_status" id="pregnancyStatus" class="form-select">
                                    <option value="active" <?php echo e(($pregnancy?->pregnancy_status ?? 'active') === 'active' ? 'selected' : ''); ?>>En cours</option>
                                    <option value="delivered" <?php echo e(($pregnancy?->pregnancy_status) === 'delivered' ? 'selected' : ''); ?>>Accouchée</option>
                                    <option value="missed" <?php echo e(($pregnancy?->pregnancy_status) === 'missed' ? 'selected' : ''); ?>>Fausse couche</option>
                                    <option value="terminated" <?php echo e(($pregnancy?->pregnancy_status) === 'terminated' ? 'selected' : ''); ?>>Interruption</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="preg-form-grid preg-form-grid-4">
                            <div class="preg-field">
                                ...
                                <select name="blood_type" class="form-select">
                                    ...
                                    <?php $__currentLoopData = ['A','B','AB','O']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bt); ?>" <?php echo e(($pregnancy?->blood_type) === $bt ? 'selected' : ''); ?>><?php echo e($bt); ?></option>
                            ...
                            <div class="preg-field">
                                ...
                                <select name="rh_factor" class="form-select">
                                    <option value="">-</option>
                                    <option value="positive" <?php echo e(($pregnancy?->rh_factor) === 'positive' ? 'selected' : ''); ?>>Rh+</option>
                                    <option value="negative" <?php echo e(($pregnancy?->rh_factor) === 'negative' ? 'selected' : ''); ?>>Rh-</option>
                                </select>
                            </div>
                            <div class="preg-field">
                                ...
                                <select name="partner_blood_type" class="form-select">
                                    <option value="">-</option>
                                    <?php $__currentLoopData = ['A','B','AB','O']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($bt); ?>" <?php echo e(($pregnancy?->partner_blood_type) === $bt ? 'selected' : ''); ?>><?php echo e($bt); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="preg-field">
                                ...
                                <select name="partner_rh_factor" class="form-select">
                                    <option value="">-</option>
                                    <option value="positive" <?php echo e(($pregnancy?->partner_rh_factor) === 'positive' ? 'selected' : ''); ?>>Rh+</option>
                                    <option value="negative" <?php echo e(($pregnancy?->partner_rh_factor) === 'negative' ? 'selected' : ''); ?>>Rh-</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="preg-form-grid preg-form-grid-4">
                            <?php $__currentLoopData = [
                                ...
                                <div class="preg-field">
                                    ...
                                    <select name="<?php echo e($field); ?>" class="form-select">
                                        <option value="">Non fait</option>
                                        <?php $__currentLoopData = ['negative' => 'Négatif', 'positive' => 'Positif', 'immune' => 'Immunisée']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $lbl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($val); ?>" <?php echo e(($pregnancy?->{$field}) === $val ? 'selected' : ''); ?>><?php echo e($lbl); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <div class="preg-field">
                                <label>RAI</label>
                                <input type="text" name="rai_result" class="form-control" placeholder="Négatif, Positif..." value="<?php echo e(old('rai_result', $pregnancy?->rai_result)); ?>">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="preg-form-grid preg-form-grid-2">
                            <div class="preg-field">
                                ...
                                <select name="risk_level" class="form-select">
                                    <option value="low" <?php echo e(($pregnancy?->risk_level ?? 'low') === 'low' ? 'selected' : ''); ?>>Faible</option>
                                    <option value="moderate" <?php echo e(($pregnancy?->risk_level) === 'moderate' ? 'selected' : ''); ?>>Modéré</option>
                                    <option value="high" <?php echo e(($pregnancy?->risk_level) === 'high' ? 'selected' : ''); ?>>Élevé</option>
                                </select>
                            </div>
                            <div class="preg-field">
                                <label>Notes</label>
                                <textarea name="notes" class="form-control" rows="2" placeholder="Facteurs de risque, observations..."><?php echo e(old('notes', $pregnancy?->notes)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </form>
...
<?php /**PATH D:\xampp8.2\htdocs\fils_attente\Modules\Gynecology\Providers/../Resources/views/partials/pregnancy-form.blade.php ENDPATH**/ ?>