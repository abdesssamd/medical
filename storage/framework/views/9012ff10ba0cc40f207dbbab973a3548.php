                        ...
                        <form id="ris-report-form" method="POST" action="<?php echo e(route('ris.exams.report', $order)); ?>">
                            ...
                            <div class="risx-editor-shell risx-card">
                                <div class="risx-editor-toolbar">
                                    <button type="button" data-editor-command="bold" class="risx-btn">B</button>
                                    <button type="button" data-editor-command="italic" class="risx-btn">I</button>
                                    <button type="button" data-editor-command="underline" class="risx-btn">U</button>
                                    <button type="button" data-editor-command="insertOrderedList" class="risx-btn">1. Liste</button>
                                    <button type="button" data-editor-command="insertUnorderedList" class="risx-btn">• Liste</button>
                                    <button type="button" data-editor-command="justifyLeft" class="risx-btn">Gauche</button>
                                    <button type="button" data-editor-command="justifyCenter" class="risx-btn">Centre</button>
                                    <button type="button" data-editor-command="justifyRight" class="risx-btn">Droite</button>
                                    <button type="button" data-editor-command="undo" class="risx-btn">Annuler</button>
                                    <button type="button" data-editor-command="redo" class="risx-btn">Refaire</button>
                                    ...
                                    <button type="button" data-editor-snippet="normal" class="risx-btn">Snippet</button>
                                    <div style="margin-left:auto; display:flex; gap:8px;">
                                        <button type="button" id="wordTemplateImportButton" class="risx-btn" <?php if($isLocked): echo 'disabled'; endif; ?>>Charger modele Word</button>
                                        <button type="button" id="wordExportButton" class="risx-btn">Exporter .docx</button>
                                        <button type="button" id="editorFullscreenButton" class="risx-btn">Plein ecran</button>
                                        <button type="button" id="voiceDictationButton" class="risx-btn" <?php if($isLocked): echo 'disabled'; endif; ?>>Dictee</button>
                                        <button type="button" id="aiAssistButton" data-ai-url="<?php echo e(route('ris.exams.ai.analyze', $order)); ?>" class="risx-btn risx-btn-ai" <?php if($isLocked): echo 'disabled'; endif; ?>>✦ Analyser IA</button>
                                    </div>
                                </div>
...
<style>
    ...
    .risx-editor-toolbar { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; padding: 10px; border-bottom: 1px solid #e2e8f0; background: #f8fafc; }
