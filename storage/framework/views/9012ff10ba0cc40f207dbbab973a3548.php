            ...
            <section class="risx-card risx-side-card" style="border-color: #86efac;">
                ...
                <div style="font-size:0.84rem;display:grid;gap:6px;">
                    <div><strong>Statut:</strong>
                        <?php if($portalAccess->revoked_at): ?>
                            <span style="color:#991b1b;">Révoqué</span>
                        <?php elseif($portalAccess->verified_at): ?>
                            <span style="color:#166534;">Utilisé (<?php echo e($portalAccess->verified_at->format('d/m/Y H:i')); ?>)</span>
                        <?php elseif($portalAccess->isExpired()): ?>
                            <span style="color:#92400e;">Expiré</span>
                        <?php else: ?>
                            <span style="color:#166534;">Actif</span>
                        <?php endif; ?>
                    </div>
                    <div><strong>Code:</strong> <code style="font-size:1.1rem;letter-spacing:2px;background:#f1f5f9;padding:2px 8px;border-radius:6px;"><?php echo e($portalAccess->access_code_last4 ? str_repeat('•', 4).$portalAccess->access_code_last4 : '—'); ?></code></div>
                    <div><strong>Expire le:</strong> <?php echo e(optional($portalAccess->expires_at)->format('d/m/Y') ?: '—'); ?></div>
                    <div><strong>Email:</strong> <?php echo e($portalAccess->delivery_email ?: '—'); ?></div>
                    <div><strong>Tel:</strong> <?php echo e($portalAccess->delivery_phone ?: '—'); ?></div>
                    <?php if($portalAccess->delivery_email): ?>
                    ...
                    <div style="display:flex;gap:8px;margin-top:6px;">
                        <a href="<?php echo e(route('patient-portal.admin.show', $portalAccess)); ?>" class="risx-btn risx-btn-wide" target="_blank">Voir l'accès</a>
                        <a href="<?php echo e(route('patient-portal.admin.memo', $portalAccess)); ?>" class="risx-btn risx-btn-wide" target="_blank">Imprimer mémo</a>
                    </div>
                </div>
            </section>
            <?php endif; ?>
