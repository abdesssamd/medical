...
<div class="landing-shell">
    <header class="landing-nav">
        <span class="brand"><?php echo e(__('queue.app_name')); ?></span>
        <nav class="landing-links">
            <a href="<?php echo e(route('public.appointment.search')); ?>" class="btn btn-primary">
    ...
    <section class="landing-hero">
        <div class="landing-hero-content">
            ...
            <div class="landing-cta">
                <a href="<?php echo e(route('public.appointment.search')); ?>" class="btn-cta-primary">
        ...
        <div class="services-grid">
            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="service-card">
                    ...
                    <p class="text-muted"><?php echo e($service->name_ar ?? 'Consultation spécialisée'); ?></p>
                </div>
...
<?php /**PATH E:\xamp8.1\htdocs\medical\Modules\Appointment\Providers/../Resources/views/public/landing.blade.php ENDPATH**/ ?>